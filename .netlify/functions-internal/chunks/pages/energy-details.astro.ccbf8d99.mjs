...
const $$EnergyDetails = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$EnergyDetails;
  ...
  Ageco received a grant of over TSH 300 million for the installation of a 32 KW gasifier plant in Magungumka Village, a rice-farming community. The biomass gasifier is powered by rice husks, providing power to 200 households and businesses. With unwavering technical support from ADC Tanzania, Ageco has seen measurable success from their project.
          ...
          <div class="col-lg-2">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Category</strong> <span>Energy</span></li>
                <li><strong>Status</strong> <span>Completed</span></li>
                <li><strong>Location</strong> <span>Dar/Singida</span></li>
    ...
    </div></section><!-- End Projet Details Section -->
            ...
            <div class="position-relative h-100">
              <div class="slides-1 portfolio-details-slider swiper">
                <div class="swiper-wrapper align-items-center">
                  ...
                  <div class="swiper-slide">
                    <img src="assets/img/projects/galaxy-1.JPG" alt="">
                  </div>
    
                  <div class="swiper-slide">
                    <img src="assets/img/projects/galaxy-2.JPG" alt="">
                  </div>
    
                  <div class="swiper-slide">
                    <img src="assets/img/projects/galaxy-3.JPG" alt="">
                  </div>
    
                  <div class="swiper-slide">
                    <img src="assets/img/projects/galaxy-4.JPG" alt="">
                  </div>
          ...
          <div class="col-lg-2">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Category</strong> <span>Energy</span></li>
                <li><strong>Status</strong> <span>Completed</span></li>
                <li><strong>Location</strong> <span>Dar/Pwani</span></li>
    ...
    <section id="project-details" class="project-details">
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="position-relative h-100">
            <div class="slides-1 portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/projects/lucas1.JPG" alt="">
                </div>
  
                <div class="swiper-slide">
                  <img src="assets/img/projects/lucas2.JPG" alt="">
                </div>
  
                <div class="swiper-slide">
                  <img src="assets/img/projects/lucas3.JPG" alt="">
                </div>
          ...
          <div class="col-lg-6">
            <div class="portfolio-description">
              <h2>Lucas Engineering and Management Services(T) Company Ltd</h2>
              <p class="align">
          ...
          <div class="col-lg-2">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Category</strong> <span>Energy</span></li>
                <li><strong>Status</strong> <span>Completed</span></li>
                <li><strong>Location</strong> <span>Dar/Manyara</span></li>
    ...
    <section id="project-details" class="project-details">
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="position-relative h-100">
            <div class="slides-1 portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/tahudee .jpg" alt="">
                </div>
          ...
          <div class="col-lg-6">
            <div class="portfolio-description">
              <h2>Tanzania Human Development Foundation (TAHUDE)</h2>
              <p class="align">
          ...
          <div class="col-lg-2">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Category</strong> <span>Energy</span></li>
                <li><strong>Status</strong> <span>Completed</span></li>
                <li><strong>Location</strong> <span>Arusha/Manyara</span></li>
...
` })}`;
}, "C:/Users/Walter/Downloads/ADC-testing/src/pages/energy-details.astro", void 0);

const $$file = "C:/Users/Walter/Downloads/ADC-testing/src/pages/energy-details.astro";
const $$url = "/energy-details";

export { $$EnergyDetails as default, $$file as file, $$url as url };
