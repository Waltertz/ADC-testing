    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-4">
          <div class="col-lg-6">
            <div class="info-item d-flex flex-column justify-content-center align-items-center">
              <i class="bi bi-map"></i>
              <h3>Our Address</h3>
              <p>8 Kilimani Road, ADA Estate</p>
              <p>14110 Kinondoni</p>
              <p>P.O. Box 75297 Dar Es Salaam</p>
            </div>
          </div><!-- End Info Item -->
        ...
        <div class="row gy-4 mt-1">
          <div class="col-lg-6">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63394.059492519744!2d39.211825493114944!3d-6.7541533500650575!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x185c4dfe5a107a93%3A0x7810a65608d91440!2sADC%20Tanzania!5e0!3m2!1sen!2stz!4v1664778674489!5m2!1sen!2stz" frameborder="0" style="border:0; width: 100%; height: 384px;" allowfullscreen></iframe>
          </div><!-- End Google Maps -->

          <div class="col-lg-5 col-md-12" data-aos="fade-up" data-aos-delay="300">
            <form action="/api/messages" method="post" role="form" class="php-email-form" id="contact-form">
...
` })}`;
}, "C:/Users/Walter/Downloads/ADC-testing/src/pages/contact.astro", void 0);

const $$file = "C:/Users/Walter/Downloads/ADC-testing/src/pages/contact.astro";
const $$url = "/contact";
